...
sys.path.append("src")
from utils.tool import fstr, is_valid_smiles, calculate_tanimoto_similarity, parse_molecule
from utils.rl_utils import get_smiles_general_action_list, get_smiles_all_general_action_list
...
def main(args):
    all_action_list = get_smiles_all_general_action_list()
        ...
        if num_mol_for_action < num_of_episode:
            ...
            while len(gap_mol_list) < gap and loop<100:
                ...
                for temp_mol in temp_mol_list:
                    temp_mol_action_list = get_smiles_general_action_list(temp_mol)
