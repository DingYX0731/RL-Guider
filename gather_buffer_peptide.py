...
def main(args):
    ...
    gather_drug_list = load_dataset(args.task_id, args.data_path)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", type=str, default="/root/rl_guider/Data/peptide/peptide_editing.json", help="Path to the ZINC dataset")
