...
generation_mol_prompt_single = (
    ...
    "Your optimal goal is: {threshold_specific_prompt} "
    "Based on the previous editing process: {current_best_prompt} "
    "Now, you are suggested to edit current_best_mol according to the suggestion: {suggestion} "
