...
class ReasonerState:
    ...
    def get_generation_prompt(self):
        ...
        if self.conversation_type == "single":
            ...
            current_best_prompt = f"The molecule closest to the goal so far is current_best_mol = {self.best_mol} and please start the modification from the given current_best_mol."
