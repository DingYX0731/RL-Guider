...
sys.path.append("src")
from utils.tool import get_prop_function, get_llm_function, examine_complete, examine_complete_fast_protein, get_fast_protein_dict, get_track, get_task_info, load_dataset, load_module
...
def main(args):
    ...
    input_drug_list = load_dataset(args.task_id, args.data_path)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", type=str, default="/root/rl_guider/Data/small_molecule/small_molecule_editing_1000.txt")
    ...
    parser.add_argument("--peptide_cache_dir", type=str, default="/root/rl_guider/Data/peptide/models_class1_presentation/models", help="path to peptide model cache")
    parser.add_argument("--protein_cache_dir", type=str, default="/root/rl_guider/Data/protein/temp_pretrained_ProteinDT", help="path to protein dt model")
    parser.add_argument("--protein_model_path", type=str, default="/root/rl_guider/Data/protein/models--chao1224--ProteinCLAP_pretrain_EBM_NCE_downstream_property_prediction/snapshots/e6ada6db1b9a5895f0a3fdac187a7f29c5231e9d/pytorch_model_ss3.bin", help="path to protein model")
