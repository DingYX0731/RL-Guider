...
from utils.tool import fstr, parse_peptide, get_task_info, get_prop_function, load_dataset, load_module
...
client = OpenAI(api_key="sk-3z4y46KjqcLSie0hmgVC5JTMNIVUDLPxvYPu8sknbqLPowuH", base_url="https://api.lkeap.cloud.tencent.com/v1")
...
model_name = "/root/rl_guider/peptide_embedding_model/"
...
def main(args):
    ...
    val_drug_list = load_dataset(args.task_id, args.data_path)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", type=str, default="/root/rl_guider/Data/peptide/peptide_editing.json", help="optimized peptide path")
